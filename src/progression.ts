...
const CHALLENGE_POOL: Omit<DailyChallenge, 'id' | 'progress' | 'completed'>[] = [
  ...
  { title: 'Sniper Elite', description: 'Deploy a Sniper in any match', type: 'deploy_class', target: 1, reward: 75 },
  { title: 'Heavy Hitter', description: 'Deploy a Heavy in any match', type: 'deploy_class', target: 1, reward: 75 },
